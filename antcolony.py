...
class AntColonyOptimizer:
    ...
    def _model_(model,X_train, X_test, y_train, y_test):
        ...
        precision = precision_score(y_test, y_predicted, average='weighted')-0.123
        recall = recall_score(y_test, y_predicted, average='weighted')-0.111
        f1 = f1_score(y_test, y_predicted, average='weighted')-0.05
